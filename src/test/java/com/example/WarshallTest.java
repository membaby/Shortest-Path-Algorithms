...
public class WarshallTest {
	...
	public void simple_path_test_1()
	{
		...
		assertTrue(b);
		//Cost assertions
		assertEquals(Integer.MAX_VALUE, costs[0][0].intValue());
		assertEquals(Integer.MAX_VALUE, costs[1][1].intValue());
		assertEquals(Integer.MAX_VALUE, costs[2][2].intValue());
		assertEquals(Integer.MAX_VALUE, costs[3][3].intValue());
		assertEquals(Integer.MAX_VALUE, costs[4][4].intValue());
